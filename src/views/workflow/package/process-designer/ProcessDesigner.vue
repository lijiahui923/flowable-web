    ...
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-edit-outline" @click="onCancel">返回</el-button>
  ...
  methods: {
    ...
    onSave () {
      ...
      this.bpmnModeler.saveXML({ format: true }).then(({ xml }) => {
        const json_xml = {xml: xml }
        const result = { ...process, json_xml }
